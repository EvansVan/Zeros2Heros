...
def get_load_data_from_entsoe(regions, periodStart='202301240000', periodEnd='202302240000', output_path='./data'):
...
def get_gen_data_from_entsoe(regions, periodStart='202301240000', periodEnd='202302240000', output_path='./data'):
